...
import { generateLocationOptions, formatPoints } from '../utils/dateUtils';
  ...
  return (
    <div>
      ...
      <div className="flex items-center gap-4 text-green-300 text-sm mb-4">
        ...
        {/* A photo with no state skips that question */}
        {currentGuess.state && (
          <div className="flex items-center gap-1">
            <Check className="w-4 h-4" />
      ...
      <p className="text-white/50 text-sm text-center mt-4">
        Correct city earns +{formatPoints(GAME_CONFIG.POINTS.CITY)} ({turnScore + GAME_CONFIG.POINTS.CITY} total)
      </p>
    </div>
  );
};
