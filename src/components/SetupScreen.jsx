...
const SetupScreen = () => {
  ...
  const { YEAR, MONTH, DAY, COUNTRY, STATE, CITY } = GAME_CONFIG.POINTS;
        ...
        >
          ...
          {gameMode === GAME_CONFIG.MODES.DATE ? (
            <ul className="space-y-1">
              ...
              <li>• Correct year: +{formatPoints(YEAR)}, + month: {YEAR + MONTH} total, + day: {YEAR + MONTH + DAY} total</li>
            ...
            <ul className="space-y-1">
              ...
              <li>• Correct country: +{formatPoints(COUNTRY)}, + state: {COUNTRY + STATE} total, + city: {COUNTRY + STATE + CITY} total</li>
              <li>• Wrong guess ends your turn</li>
              <li>• First to {GAME_CONFIG.WINNING_SCORE} points wins!</li>
            </ul>
          )}
