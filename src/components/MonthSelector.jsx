...
import { MONTH_NAMES, formatPoints } from '../utils/dateUtils';
  ...
  return (
    <div>
      ...
      <p className="text-white/50 text-sm text-center mt-3">
        Correct month earns +{formatPoints(GAME_CONFIG.POINTS.MONTH)} ({turnScore + GAME_CONFIG.POINTS.MONTH} total)
      </p>
    </div>
  );
};
