...
import { MONTH_NAMES, getDaysInMonth, formatPoints } from '../utils/dateUtils';
  ...
  return (
    <div>
      ...
      <p className="text-white/50 text-sm text-center mt-3">
        Correct day earns +{formatPoints(GAME_CONFIG.POINTS.DAY)} ({turnScore + GAME_CONFIG.POINTS.DAY} total)
      </p>
    </div>
  );
};
